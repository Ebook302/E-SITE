...
<head>
  ...
  <title>הספרים של E/אסתר אברהמי</title>
  ...
  <style>
    ...
    h2 {
      color: #7c5c45;
      border-bottom: 1px solid #d3c0aa;
      padding-bottom: 10px;
    }
...
<body>
  ...
  <section>
    ...
    <p>
      היי לכולם ! 
      אני אסתר אברהמי, בחורה משונה שאוהבת כתיבה. 
      ...
      אני נרגשת להציג לכם את האתר שבניתי לי, הוא כולל קישור לספר שפירסמתי ולספר שאפרסם בקרוב. 
      ...
      זאת אמנם ההתחלה אבל כולי תקווה ומחשבה על איך לשפר אותו ולהניש אותו לכל עין שרק רוצה לקרוא, לכל אדם שרוצה לחוות, לכל נפש שמעוניינת לחוות. 
